        ...
        <div class="login-form bg-white p-4 shadow-sm mx-auto rounded">
            <form class="validate-form" action="<?php echo CURRENT_URI; ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="pwd" id="pwd" class="form-control validate-target" required minlength="4" maxlength="60">
                    <div class="invalid-feedback"></div>
                </div>
                <div class="form-group">
                    <label for="nickname">ニックネーム</label>
                    <input type="nickname" name="nickname" id="nickname" class="form-control validate-target" required>
                    <div class="invalid-feedback"></div>
                </div>

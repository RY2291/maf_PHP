        ...
        input.addEventListener('input', function(event){
            ...
            if(target.checkValidity()){
                ...
                if(target.validity.valueMissing){
                    ...
                    feedback.textContent = target.minLength + '字以上で入力してください。現在の文字数は' + target.value.length + 'です。';
                }else if(target.validity.tooLong) {
                    feedback.textContent = target.maxLength + '字以下で入力してください。現在の文字数は' + target.value.length + 'です。';
